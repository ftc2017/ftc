...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/zichanzhanghu_data.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/jquery-1.8.1.min.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/bootstrap.min.js"></script>
     ...
     <div class="row c-row row_5nREyb"><div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 c-column column_bPfYj4">
       <div class="c-div div_KCW7ki">
        <div class="c-div div_bSlUbp">
         <a class="btn c-button button_pQ6Pve1" data-c_act_id="M_c2cddedffbac1359" data-c_e_id="button_500c9413" type="button">
          创建
          <br/>
         </a>
        </div>
  ...
  <div class="c-div div_JCg5T5">
   <div class="c-div div_5u8t7h">
    <div class="c-div div_wsiTRg">
      <?php if(is_array($account)): $i = 0; $__LIST__ = $account;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="c-div div_YkVr1w">
        <h1 class="c-heading heading_NKCspZ">
          <?php if($v['member_account_currency'] == '1'): ?>比特币（BTC）
         <?php elseif($v['member_account_currency'] == '2'): ?>
          银行名称（RMB）
          <?php else: ?>
          莱特币（LTC）<?php endif; ?>
        </h1>
        ...
        <label class="c-label label_BVwrDf">
         <?php echo ($v['member_account_number']); ?>
        </label>
