...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/workspace_data.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/jquery-1.8.1.min.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/bootstrap.min.js"></script>
  ...
  <nav class="navbar c-navbar navbar_ev1lH4">
   <div class="container-fluid navcontainer_coyyEt">
    <div class="navbar-header c-navheader navheader_zi2nZC">
     <button class="navbar-toggle c-navmenubutton navmenubutton_53QFzk" data-target="#navmenu_319ffb7d98909bb3" data-toggle="collapse" type="button">
    ...
    <div class="collapse navbar-collapse c-navcollapse navcollapse_WPenC0" id="navmenu_319ffb7d98909bb3">
     <ul class="nav navbar-nav navbar-left c-navlist navlist_sxcRyD">
      ...
      <li class="c-navlistitem navlistitem_ojejya">
       <a class="c-navlink navlink_mQpNCY" href="#">
        项目
       </a>
      </li>
      ...
      <li class="c-navlistitem navlistitem_t8aTZa">
       <a class="c-navlink navlink_mQpNCY" href="#">
        贸易
       </a>
      </li>
      <li class="c-navlistitem navlistitem_k1dedQ">
       <a class="c-navlink navlink_mQpNCY" href="#">
        金融
       </a>
      </li>
      <li class="c-navlistitem navlistitem_UzFIy2">
       <a class="c-navlink navlink_mQpNCY" href="#">
        保险
       </a>
      </li>
      <li class="c-navlistitem navlistitem_VgKB7J">
       <a class="c-navlink navlink_mQpNCY" href="#">
        财务
       </a>
      </li>
      <li class="c-navlistitem navlistitem_3FrD3F">
       <a class="c-navlink navlink_mQpNCY" href="#">
        投资
       </a>
      </li>
      <li class="c-navlistitem navlistitem_v5WbVh">
       <a class="c-navlink navlink_mQpNCY" href="#">
        团队
       </a>
      </li>
      <li class="c-navlistitem navlistitem_Nv6Hy4">
       <a class="c-navlink navlink_mQpNCY" href="#">
        合作伙伴
       </a>
      </li>
      <li class="c-navlistitem navlistitem_7ygV8V">
       <a class="c-navlink navlink_mQpNCY" href="#">
        投资者
       </a>
      </li>
      <li class="c-navlistitem navlistitem_PbVoIQ">
       <a class="c-navlink navlink_mQpNCY" href="#">
        设置
       </a>
      </li>
      <li class="c-navlistitem navlistitem_1wWn1Z">
       <a class="c-navlink navlink_mQpNCY" href="#">
        商品
       </a>
      </li>
      <li class="c-navlistitem navlistitem_O8tqJO">
       <a class="c-navlink navlink_mQpNCY" href="#">
        应用市场
       </a>
      </li>
