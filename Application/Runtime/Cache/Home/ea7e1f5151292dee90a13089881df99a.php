...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/wodeqianbao_data.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/jquery-1.8.1.min.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/bootstrap.min.js"></script>
      ...
      <li class="dropdown c-dropdown c-dropdown-hover navdropdown_miWvhD">
       ...
       <ul class="dropdown-menu c-dropdown-menu c-dropdown-menu-hover dropdownmenu_Bd76KR" role="menu">
        <li class="c-dropdown-listitem dropdownlistitem_MNy95N" role="presentation">
         <a class="c-dropdown-textlink dropdowntextlink_xD5nkD" href="<?php echo U('index/workspace');?>" role="menuitem" tabindex="-1">
          工作空间
         </a>
        </li>
  ...
  <div class="c-div div_JCg5T5">
   <div class="c-div div_5u8t7h">
    <div class="c-div div_wsiTRg">
     <div class="modal c-modal c-dialog-0 dialog_bsKq6q" data-c_e_id="dialog_2c79b943">
      <div class="modal-dialog c-modal-dialog dialogwrap_8eZf9V">
       <div class="modal-content c-modal-content dialogcontent_ytLuXP">
        <div class="modal-header c-modal-header dialogheader_u0fhEY">
         <button class="close dialog-close c-defaultbutton defaultbutton_4HgQCV" data-dismiss="modal" type="button">
          <span aria-hidden="True" class="c-span span_MwyOje">
           ×
          </span>
          <span class="sr-only c-span span_o7PGmz">
           close
          </span>
         </button>
         <h4 class="modal-title c-heading heading_qi8rXE">
          充值
          <br/>
         </h4>
        </div>
        <div class="modal-body c-modal-body dialogbody_VGNJUr">
         <div class="row c-row row_eu12Wa"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_RapAGf">
           <form action="money_list" class="c-form form_Q3hr3y" data-redirect="/success" method="post" way="ajax">
            <label class="c-label label_j68Yva">
             币种
             <br/>
            </label>
            <select class="c-select select_p8fRjL" name="member_account_currency">
             <option class="c-option option_IxjTFV" value="">
              选择...
             </option>
             <option class="c-option option_NmjbrR" value="1">
              比特币
             </option>
             <option class="c-option option_FBEeuR" value="2">
              人民币
             </option>
             <option class="c-option option_eyyYod" value="3">
              以太币
             </option>
            </select>
          </div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_dUNz63">
          </div>
         </div>
         <div class="row c-row row_eu12Wa"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_RapAGf">
            <label class="c-label label_2tAJHV">
             收款人
             <br/>
            </label>
            <input class="c-input input_45k545" name="付款金额" placeholder="" type="text"/>
            <label class="c-label label_j68Yva">
             收款账户
             <br/>
            </label>
            ...
            <input class="c-input input_45k545" name="user_id" placeholder="" value="<?php echo ($member['real_name']); ?>" type="text"/>
            <label class="c-label label_j68Yva">
             付款账户
             <br/>
            </label>
            <select class="c-select select_p8fRjL" name="member_account_id">
             <option class="c-option option_IxjTFV" value="">
              选择...
             </option>
             <?php if(is_array($account)): $i = 0; $__LIST__ = $account;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option class="c-option option_NmjbrR" value="<?php echo ($v['member_account_id']); ?>">
                  <?php echo ($v['member_account_bank']); echo ($v['member_account_number']); ?>
            ...
            <input class="c-input input_45k545" name="member_recharge_money" placeholder="" type="text"/>
           
           <!-- <label class="c-label label_2tAJHV">
            上传回单
            <br/>
           </label>
           <div class="c-inlineblock c-imageblock imageblock_etgeKK" mode="scaleToFill" src="http://o3bnyc.creatby.com/diazo/images/image-placeholder.svg" style="background-size: 100% 100%; background-position: 0% 0%; background-repeat: no-repeat; background-image: url(http://o3bnyc.creatby.com/diazo/images/image-placeholder.svg);">
           </div> -->
          </div>
         </div>
         <a class="c-textlink textlink_R5YcX0" href="#">
          充值协议
          <br/>
         </a>
        </div>
        <div class="modal-footer c-modal-footer dialogfooter_Ra8iXG">
         <button class="btn btn-primary c-defaultbutton defaultbutton_wf9Rc4" type="submit">
          确认
          <br/>
         </button>
        </div>
     ...
     <div class="c-div div_YkVr1w">
      ...
      <a class="btn-default btn bsbutton_8i74ER" data-c_act_id="M_cb8b18e0e9a43498" options="btn btn-default" sizes="" type="button">
       充值
      </a>
     </div>
     <div class="c-div div_YkVr1w">
      ...
      <a class="btn-default btn bsbutton_8i74ER" href="#" data-c_act_id="M_cb8b18e0e9a43498" options="btn btn-default" sizes="" type="button">
       充值
      </a>
     </div>
     <div class="c-div div_YkVr1w">
