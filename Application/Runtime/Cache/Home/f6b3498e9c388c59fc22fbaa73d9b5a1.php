...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/chuangjianzczh_data.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/jquery-1.8.1.min.js"></script>
    <script type="text/javascript" src="/Public/Home/thirdparty_js/bootstrap.min.js"></script>
...
<body class="body_FP8sWk" data-c_tl_id="M_ebf1e60d7e3a83a6">
 ...
 <div class="c-div div_ZiljEp">
  <div class="c-div div_svWPQ0">
    ...
    <div class="c-div div_lCFmVo">
     <div class="row c-row row_5nREyb"><div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 c-column column_bPfYj4">
       <div class="c-div div_bSlUbp">
        ...
        <a class="btn c-button button_pQ6Pve1" data-c_act_id="M_0a1aa45e2c84240d|M_93eabd080a7da2aa" data-c_e_id="button_500c9413" type="button">
         创建
         <br/>
        </a>
        <a class="btn c-button c-initHide button_pQ6Pve" data-c_act_id="act_4ab17119|act_222a6d9f" data-c_e_id="button59eca9b9" id="baocun" type="button">
         保存
         <br/>
        </a>
   ...
   <div class="c-div c-initHide div_axkOvB">
    <div class="row c-row row_oeEutd"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_3Nh2Fd">
      <a class="btn c-button button_VkoEjl" type="button">
       提交
      </a>
      <a class="btn c-button button_VkoEjl" type="button">
       审核
     ...
     </div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_8a4MmL">
     </div>
    </div>
   </div>
  </div>
  <div class="c-div div_JCg5T5">
   <div class="c-div div_CAdIMo">
    <div class="container c-container container_xNRtx1" data-c_e_id="container_f0050eb6">
     <div class="row c-row row_deMbRn"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_6IFD9M">
       <form action="" class="c-form form_cPhpox" data-redirect="/success" method="get" name="form">
        <label class="c-label label_fytpH8">
         资产账户号码
         <br/>
        </label>
        <h1 class="c-heading heading_FNAf2H">
         FTCID20170520001A
         <br/>
        </h1>
       </form>
      </div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_Whv1gW">
      </div>
     </div>
     <div class="row c-row row_CuxrAc"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_CLG1uE">
       <form action="" class="c-form form_v7YPiz" data-redirect="/success" method="get" name="form">
        <label class="c-label label_myUTAP">
         开户行
        </label>
        <p class="c-paragraph paragraph_5bJMGt-2">
         中国工商银行
         <br/>
        </p>
        <p class="c-paragraph paragraph_5bJMGt-2">
      ...
      </div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_UhSa1Q">
       <form action="" class="c-form form_DUIiFU" data-redirect="/success" method="get" name="form">
        <label class="c-label label_7Rv2iQ">
         帐户类型
        </label>
        <p class="c-paragraph paragraph_5bJMGt-2">
         私人账户
       ...
       <form action="" class="c-form form_YZBhQv" data-redirect="/success" method="get" name="form">
        <label class="c-label label_llNVHo">
         币种
        </label>
        <p class="c-paragraph paragraph_5bJMGt-2">
         人民币
    ...
    <div class="container c-container c-initHide container_xNRtx1" data-c_e_id="container029ffd09">
     <div class="row c-row row_deMbRn"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_6IFD9M">
       <form action="cjzh" id="cjzh" class="c-form form_cPhpox" data-redirect="/success" method="post" way="ajax">
        <label class="c-label label_fytpH8">
         资产账户号码
         <br/>
        </label>
        <input class="c-input input_xm2FSZ verify" name="member_account_number" placeholder="资产账户号码" type="text"/>
       <!-- </form> -->
      </div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_Whv1gW">
      </div>
     </div>
     <div class="row c-row row_CuxrAc"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_CLG1uE">
       <!-- <form action="" class="c-form form_v7YPiz" data-redirect="/success" method="get" name="form"> -->
        ...
        <select class="c-select select_QCS5Sc" name="member_account_bank">
         <option class="c-option option_zEr1Be" value="1">
          中国工商银行
         </option>
         <option class="c-option option_NT5v5M" value="2">
          招商银行
         </option>
         <option class="c-option option_Sx90DI" value="3">
          比特币
         </option>
        </select>
       <!--  <select class="c-select select_hbo93r" name="select">
         <option class="c-option option_OYmKOs" value="opt1">
          工行天津分行天宝支行
         </option>
        </select> -->
     <!--   </form>
       <form action="" class="c-form form_v7YPiz" data-redirect="/success" method="get" name="form"> -->
        ...
        <select class="c-select select_hbo93r" name="member_account_name">
         <option class="c-option option_OYmKOs" value="<?php echo ($_SESSION['user']['real_name']); ?>">
       ...
       <!-- <form action="" class="c-form form_DUIiFU" data-redirect="/success" method="get" name="form"> -->
        ...
        <select class="c-select select_YUC0yF" name="member_account_type">
         <option class="c-option option_3p9knt" value="1">
          私人帐户
         </option>
         <option class="c-option option_399M1v" value="2">
          企业帐户
         </option>
        </select>
       <!-- </form>
       <form action="" class="c-form form_YZBhQv" data-redirect="/success" method="get" name="form"> -->
        ...
        <select class="c-select select_wj3kk5" name="member_account_currency">
         <option class="c-option option_YzF3fL" value="1">
          比特币
         </option>
         <option class="c-option option_hx25x6" value="2">
          人民币
         </option>
         <option class="c-option option_n5dwV4" value="3">
          以太币
         </option>
        </select>
       </form>
