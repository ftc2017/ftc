...
<head>
    ...
    <!-- // <script type="text/javascript" src="/Public/Home/js/index_data.js"></script> -->
 ...
 <div class="container-fluid c-section section_Wl9Fwc" data-c_tl_id="tl_f0901961c7d48a6739beb995b48eff8c" id="section29e0c944">
  <div class="c-div div_d5ltqK">
   <div class="container c-container container_1oVg7Q signup">
    <div class="row c-row row_Kjbz8z"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_mvZe5k">
      <img class="c-image image_cE42dr" src="/Public/Home/files/5d54717483ef28a4c818ec25b3ee333e.png"/>
     ...
     </div><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_EXJ39w">
      ...
      <form action="" class="c-form form_mgltEd" data-redirect="/success" method="post" way="ajax">
       ...
       <input class="c-input input_ju04Ga" name="mobile" placeholder="请输入手机号" required="True" type="number"/>
       <label class="c-label label_3UG6Ic">
        密码:
       </label>
       <input class="c-input input_8FlkY6" name="password" placeholder="请输入密码" required="True" type="password"/>
       <div class="checkbox c-checkbox checkbox_HIxYhD">
        <input class="c-checkbox-input checkboxinput_rJ8h62" name="checkbox" type="checkbox"/>
        <label class="c-form-label formlabel_JHMH8L">
         保持登陆
        </label>
       </div>
       <label class="c-label label_pkAnzK" data-c_act_id="M_384035e7da3215f8">
        <a href="<?php echo U('Account/forgetPass');?>">忘记密码？</a>
       </label>
       <button class="submit_n7xCQ7" data-c_act_id="M_e932e866ff74b0c2" name="" type="submit" wait="">
        登录
       </button>
       <a class="btn c-button submit_n7xCQ7 regi" data-c_act_id="M_40eaf96e15247c38" href="<?php echo U('Account/regist');?>" >
        免费注册
       </a>
      </form>
     </div>
