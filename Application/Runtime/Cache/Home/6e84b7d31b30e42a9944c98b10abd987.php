...
<head>
    ...
    <!-- // <script type="text/javascript" src="/Public/Home/js/signup_data.js"></script> -->
...
<body class="body_wopKXi">
 <div class="container-fluid c-section section_Wl9Fwc" data-c_tl_id="tl_f0901961c7d48a6739beb995b48eff8c">
  <div class="c-div div_d5ltqK">
   <div class="container c-container container_1oVg7Q signup">
    <div class="row hidden-xs c-row row_Kjbz8z"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_mvZe5k">
      ...
      <form action="/Home/Account/regist" class="c-form form_mgltEd" data-redirect="/success" method="post"  way="ajax">
       <label class="c-label label_hq1X7i">
        手机号:
       </label>
       <input class="c-input input_ju04Ga signup verify phoneNumber" name="mobile" placeholder="请输入注册手机号" id="mobile" required="True" type="number"/>
       <div class="c-div div_WbM5eO">
        <input class="c-input input_sA8NFY" name="code" placeholder="验证码" type="number"/>
        <button class="submit_42f7Xl" id="register_btn" name="" type="button" wait="">
         获取验证码
        </button>
       </div>
      <!--  <label class="c-label label_3UG6Ic">
       ...
       <input class="c-input input_ju04Ga signup" name="user_name" placeholder="昵称" required="True" type="text"/>
       <div class="checkbox c-checkbox checkbox_HIxYhD">
        <input class="c-checkbox-input checkboxinput_rJ8h62" name="checkbox" required="True" type="checkbox" value="1"/>
        <label class="c-form-label formlabel_JHMH8L">
         我已经认真阅读并同意FTC的《使用协议》。
        </label>
       </div>
       ...
       <a class="btn c-button submit_n7xCQ7 regi" data-c_act_id="M_32eda54a54b8687b" href="<?php echo U('Account/login');?>" >
        登录
       </a>
      </form>
     </div>
