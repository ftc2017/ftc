...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/page3_data.js"></script>
  ...
  <div class="c-div div_d5ltqK">
   <div class="container c-container container_1oVg7Q signup">
    <div class="row c-row row_Kjbz8z"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 c-column column_mvZe5k">
      ...
      <form action="" class="c-form form_o9Azhy" data-redirect="/success" method="post" way="ajax">
       <label class="c-label label_hq1X7i">
        FTC帐户:
       </label>
       <div class="c-div div_WbM5eO">
        <input class="c-input input_sA8NFY verify phoneNumber" name="mobile" id="mobile" placeholder="Enter your mobile" type="number"/>
        <button class="submit_42f7Xl" name="" id="register_btn" type="button" wait="">
         获取验证码
        </button>
       </div>
     <!--  </form>
      <form action="" class="c-form form_mgltEd" data-redirect="/success" method="get" name="form"> -->
       ...
       <input class="c-input input_8FlkY6" name="code" placeholder="验证码" required="True" type="text"/>
       <button class="submit_n7xCQ7"  name="" type="submit" wait="">
        提交
       </button>
       <button class="btn c-button submit_n7xCQ7 regi" data-c_act_id="M_40eaf96e15247c38" href="signup.html" type="button">
        登录
       </button>
      </form>
     </div>
